...
## This is a copied repository from Excel-2.0.1, where the Archive dependency has been changed to 3.4.9 due to exceptions being thrown when deleting or renaming 'Sheet1'. 
